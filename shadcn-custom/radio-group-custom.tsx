...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Root
      className={cn("grid gap-2 m-1", className)}
      {...props}
      ref={ref}
    />
  );
