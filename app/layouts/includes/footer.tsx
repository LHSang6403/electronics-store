export default function Footer(): JSX.Element {
  return (
    <footer className="w-full px-[calc((100%-1050px)_/_2)] xl:px-6 lg:px-6 sm:px-4 bg-[#EEEEEE] text-black py-8">
      <div
      ...
      >
        <div className="w-full">
          <img
            className="w-[150px] h-9 lg:w-[120px] lg:h-7 sm:w-[100px] sm:h-6"
            alt="logo"
            src="/assets/logo.png"
          ></img>
          <hr
