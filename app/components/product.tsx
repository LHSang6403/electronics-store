...
export default function Product(props: ProductData): JSX.Element {
  ...
  return (
    <div className="w-36 h-48 xl:w-[156px] sm:w-full sm:max-w-36 sm:h-48 mx-2 xl:mx-auto my-4 sm:my-2 rounded-xl shadow-lg flex flex-col items-center justify-start bg-[#EEEEEE] hover:cursor-pointer">
